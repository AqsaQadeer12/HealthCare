...
function Settings() {
    ...
    return (
        <div className={`min-h-screen p-4 sm:p-6 transition-all duration-500 ${dark ? "bg-gray-900 text-white" : "bg-gray-100 text-gray-800"}`}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                {/* SYSTEM */}
                <div className={`p-6 rounded-2xl shadow-lg lg:col-span-3 md:col-span-2 ${dark ? "bg-gray-800" : "bg-white"}`}>
                    <h2 className="text-xl font-semibold mb-4">System Preferences</h2>

                    <div className="flex justify-between items-center mb-4 flex-col sm:flex-row sm:gap-0 gap-2">
                        <span>Compact Mode</span>
                        <Toggle enabled={compact} setEnabled={setCompact} />
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <select className={`p-3 rounded-lg w-full ${dark ? "bg-gray-700 text-white" : "bg-gray-100 text-gray-900"}`}>
